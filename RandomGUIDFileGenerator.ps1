...
(
    ...
    [parameter(mandatory=$true)][int]$_5kFiles,
    [parameter(mandatory=$true)][int]$_10kFiles,
    [parameter(mandatory=$true)][int]$_20kFiles,
    [parameter(mandatory=$true)][int]$_50kFiles,
    [parameter(mandatory=$true)][int]$_100kFiles,
    [parameter(mandatory=$true)][int]$_200kFiles,
    [parameter(mandatory=$true)][int]$_500kFiles,
    [parameter(mandatory=$true)][int]$_1MBFiles,
    [parameter(mandatory=$true)][int]$_2MBFiles,
    [parameter(mandatory=$true)][int]$_5MBFiles,
...
ForEach ($Parameter in $ParamMatrix)
{
    ...
    If ((($Parameter.Name -like "_*") -and ($Parameter.Value -gt 0))-or (($Parameter.Name -eq 'CustomSize') -and $CustomCount -gt 0))
    {
        ...
        Write-Host 'Before the switch.. to be checked: ' $($Parameter.Name)
        ...
        Write-Host 'After the switch.. RandomCharNum: ' $RandomCharNum
        ...
        For ($i=1; $i -le $FilesToGenerate; $i++)
        {
            ...
            Write-Host 'RandomCharNum: ' $RandomCharNum
